...
pub fn decode(
    ...
    let packet = crate::ucs03_zkgm_0::packet::decode(&packet.data).context("decode packet")?;

    let mut value = serde_json::to_value(packet).context("formatting json")?;
    ...
    match json {
        ...
        Value::Object(map) => {
            ...
            for (key, value) in map.iter_mut() {
                if key != "_path" {
                    // Avoid overwriting existing "_parents"
