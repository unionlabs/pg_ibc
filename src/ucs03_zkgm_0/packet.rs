        ...
        S: Serializer,
    {
        ...
        let metadata_value = match self.metadata_type {
            ...
            1 => {
                ...
                match <FungibleAssetMetadata>::abi_decode_sequence(&self.metadata, false) {
    ...
    pub fn decode_operand(&self) -> Result<Operand> {
        Ok(match (self.version, self.opcode) {
            ...
            (2, OP_FUNGIBLE_ASSET_TRANSFER) => Operand::FungibleAssetOrder(FungibleAssetOrder::V2(
                <FungibleAssetOrderV2>::abi_decode_sequence(&self.operand, false)
...
mod tests {
    ...
    #[test]
    fn test_parse_ucs03_zkgm_0_with_fungible_asset_transfer_v2_packet_metadata_type_0() {
    ...
    #[test]
    fn test_parse_ucs03_zkgm_0_with_fungible_asset_transfer_v2_packet_metadata_type_1() {
    ...
    #[test]
    fn test_parse_ucs03_zkgm_0_with_fungible_asset_transfer_v2_packet_metadata_type_2() {
