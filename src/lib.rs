...
#[pg_extern(immutable, parallel_safe)]
fn decode_ack_0_1(packet: &[u8], ack: &[u8], channel_version: &str, flatten: bool) -> pgrx::JsonB {
    let result = match channel_version {
        "ucs03-zkgm-0" => ucs03_zkgm_0::ack::decode(packet, ack, flatten),
        _ => Err(
...
#[pg_extern(immutable, parallel_safe)]
fn decode_packet_0_1(input: &[u8], channel_version: &str, flatten: bool) -> pgrx::JsonB {
    let result = match channel_version {
        "ucs03-zkgm-0" => ucs03_zkgm_0::packet::decode(input, flatten),
        _ => Err(
...
mod tests {
    ...
    fn test_decode_packet_0_1_error_selecting_decoder() {
        let json = decode_packet_0_1(&hex::decode("0b").unwrap(), "does-not-exist", false);
    ...
    #[test]
    fn test_decode_packet_0_1_error_selecting_decoder_flattened() {
        let json = decode_packet_0_1(&hex::decode("0b").unwrap(), "does-not-exist", true);
    ...
    fn test_decode_packet_0_1_error_decoding() {
        let json = decode_packet_0_1(&hex::decode("0b").unwrap(), "ucs03-zkgm-0", false);
    ...
    fn test_decode_packet_0_1_error_decoding_flattened() {
        let json = decode_packet_0_1(&hex::decode("0b").unwrap(), "ucs03-zkgm-0", true);
    ...
    #[test]
    fn test_decode_ack_0_1_success_flattened() {
        let json = decode_ack_0_1(&hex::decode("").unwrap(), &hex::decode("").unwrap(),"ucs03-zkgm-0", true);
